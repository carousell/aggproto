...
examples: clean install
	...
	protoc --go_out=examples/goOut --go-grpc_out=examples/goOut --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative --proto_path=examples/protoOut complex_v1/complex_usecase.proto
