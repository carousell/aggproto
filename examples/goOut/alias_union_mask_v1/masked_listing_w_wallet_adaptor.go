...
import (
	...
	"github.com/carousell/aggproto/examples/goOut/listing_comments.ListingComment"
...
func adaptMaskedListingWWalletResponse(getListingResponse *listing.GetListingResponse, getListingCommentsResponse *listing_comments.GetListingCommentsResponse, getUserWalletResponse *wallet.GetUserWalletResponse) *MaskedListingWWalletResponse{
	...
	listingComment := getListingCommentsResponse.ListingComment
	comments := listingComment.Comments
	...
	resp.Listing.Comments = &MaskedListingWWalletResponse_ListingGen_CommentsGen{}
	resp.Listing.Comments.Title = comments.Title
